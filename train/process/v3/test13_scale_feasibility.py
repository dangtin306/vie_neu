...
import csv, hashlib, json, random, shutil, sys, time
...
OUT = TRAIN_DIR / "output" / "test13_scale_feasibility"
CACHE_DIR = OUT / "cache"
...
def main():
    ...
    train_rows,valid_rows,test_rows=read_pairs("train_pairs.csv"),read_pairs("valid_pairs.csv"),read_pairs("test_pairs.csv"); sets=validate_split(train_rows,valid_rows,test_rows)
    global PREP_TOTAL
