...
- --fast-gpu uses BF16/SDPA when supported. Dynamic sequence trimming and the
  native+EOS-only loss keep memory efficient; the known ~9.8GB card auto-selects
  batch 3 to improve GPU occupancy.
